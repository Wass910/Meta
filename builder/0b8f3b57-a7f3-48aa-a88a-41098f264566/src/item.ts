...
export default class Button implements IScript<Props> {
  openClip = new AudioClip('0b8f3b57-a7f3-48aa-a88a-41098f264566/sounds/open.mp3')
  closeClip = new AudioClip('0b8f3b57-a7f3-48aa-a88a-41098f264566/sounds/close.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    door.addComponent(new GLTFShape('0b8f3b57-a7f3-48aa-a88a-41098f264566/models/Button_Chest.glb'))
